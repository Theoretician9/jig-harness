...
[ -r "$HARNESS_CONF" ] || { echo "memory-revision: нет $HARNESS_CONF — скопируйте харнес/config/harness.conf в /etc/harness/"; exit 1; }
...
SKILLS_DIR="$PROJECT_DIR/${SKILLS_DIR_NAME:-харнес/skills}"
